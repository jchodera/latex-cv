...
\collaboration{openbind-logo-small}{OpenBind}{2025--}{https://openbind.org}{OpenBind is a pioneering initiative creating the world’s largest open-access dataset of drug–protein interactions---to accelerate the development of new treatments. By combining cutting-edge science with open collaboration, OpenBind powers the next generation of machine learning tools for structure-based drug design, freely available to all.}
...
\collaboration{openadmet}{OpenADMET}{2024--}{http://openadmet}{Around 95\% of molecules synthesized in lead optimization fail to meet objectives for ADMET---absorption, distribution, metabolism, excretion, and toxicity. The OpenADMET project---funded by a \$30M ARPA-H grant and the Gates Foundation---aims to address this problem by building open datasets, fielding blind challenges, and building open source machine learning (ML) models to advance the state of ADMET modeling in small molecule drug discovery. In addition, the project aims to generate a wealth of novel structural and direct bioassay data for interactions of small molecules with ADMET-associated proteins, using the tools of drug discovery to generate maximally informative data specifically for building highly useful mechanistic ADMET models. I co-founded the OpenADMET project and lead the computational modeling and data aspects.}

\collaboration{covid-moonshot-logo-small}{The COVID Moonshot}{2020--2022}{https://covid.postera.ai/covid}{I co-founded the {\bf COVID Moonshot}, a global open science collaboration leveraging our free alchemical energy calculations on Folding@home to discovery a patent-free oral antiviral useful against COVID-19. Starting from an X-ray fragment screen, we produced SARS-CoV-2 main viral protease (Mpro) inhibitor preclinical candidates in just 18 months (\href{https://www.nature.com/articles/d41586-021-01571-1}{Nature Comment}). Together with the \href{http://dndi.org}{Drugs for Neglected Diseases initiative (DND$i$)}---the world's leading nonprofit developing new therapies for neglected diseases---we were \href{https://dndi.org/press-releases/2021/covid-moonshot-funded-by-wellcome-to-rapidly-develop-safe-globally-accessible-affordable-antiviral-pill/}{awarded \$11M from the WHO Access to COVID Tools Accelerator (ACT-A) via the Wellcome Trust} to carry out an accelerated preclinical program, with clinical trials expected in early 2024. Our antiviral is expected to be free of the drug-drug interactions that present difficulties to widespread use of Paxlovid, and has differentiated resistance liabilities. We are working to partner with generics manufacturers to make our antiviral available for globally equitable and affordable access.}

% TODO: Add OpenAMR
%\collaboration{openadmet}{OpenAMR}{2024--}{http://openadmet.org}{}
...
\collaboration{achira-logo}{Achira}{Oct 2024--}{http://achira.ai}{I co-founded Achira, a company building open foundation simulation models for drug discovery, and currently serve as CEO and President.}
...
Much of our software is now supported and further developed through the \href{http://omsf.io}{Open Molecular Software Foundation (OMSF)}, supported by industry consortia and federal grant funding.
...
{\small \it h-index: 70 / i10-index: 128 / citations: 28456 (10 Jan 2026)} \\
...
\includegraphics[width=2.8in,valign=t]{thumbnails/citations-2025-12-31.pdf}

\vspace{0.05in}
{\small annual citation counts via Google Scholar (31 Dec 2025)}
\end{minipage}
...
\newarticle{AshGC.jpg}{Wang L, Alibay I, Boothroyd S, Cavender CE, Horton JT, McIsaac AR, Mitchell JA, Thompson MT, Wagner JR, Westbrook BR, \jdc, Cole DJ, Shirts MR, and Mobley DL}{Developing and benchmarking Sage 2.3.0 with the AshGC neural network charge model}{\emph{Preprint}}{chemRxiv}{https://doi.org/10.26434/chemrxiv-2025-597h9}{We present AshGC, a fast new partial charge model that leverages graph neural networks within a physical charge equilibration framework, and Sage 2.3.0, a new general small molecule force field that uses this charge model. AshGC is able to generate AM1-BCC partial charges orders of magnitude faster than implementations based on semiempirical methods, and can parameterize very large molecules or large datasets in practically useful times. This provides a fast, accurate general small molecule force field that can be systematically improved in the future through joint training of the charge model and force field to arbitrary quantum chemical and experimental data targets.}

\newarticle{OpenFE-industry-benchmark-2024.jpg}{Baumann HM, Horton JT, Henry MM, Travitz A, Ries B, Gowers RJ, Swenson DWH, Pulido I, Rufa D, Dotson DL, Bansal N, Bluck JP, Broughton H, Campbell K, Cao L, Frieg B, Gapsys V, G\"{o}ddeke H, Kl\"{a}hn M, Lakkaraju SK, Linker SM, L\"{o}hr T, Magarkar A, P\'{e}rez-Conesa S, Purkey HE, Saribekyan H, Scheen J, Schindler CEM, Steinbrecher T, Stern CD, Suriana P, Swope WC, Tresadern G, Tsidilkovski L, Wei B, Williams AH, Wu Y, Zhang I, \jdc, Eastwood JRB, Mobley DL, and Alibay I}{Large-scale collaborative assessment of binding free energy calculations for drug discovery using OpenFE}{\emph{Preprint}}{chemRxiv}{https://chemrxiv.org/engage/chemrxiv/article-details/6936e3bda10c9f5ca1e61f71}{We demonstrate the OpenFE 1.0 alchemical free energy calculation ecosystem (based on OpenMM) on a large-scale benchmark on both public protein:ligand benchmark sets and internal industry benchmark sets across a number of industrial Open Free Energy Consortium members. For the public benchmark dataset, the RMSE across 58 systems was 1.73 [95\% CI: 1.53, 1.96] kcal/mol, with 10 of the systems reaching sub-kcal/mol accuracy, indicating good overall performance on these highly curated systems. While this indicates OpenFE is ready for use in real-world drug discovery, for the internal industry datasets, the RMSE across 37 systems was 2.44 [95\% CI: 1.94, 3.06] kcal/mol, with only 2 systems reaching sub-kcal/mol accuracy, indicating that significant improvements are still possible to improve accuracy, robustness, and reliability for real-world drug discovery programs.}

\newarticle{blind-challenges-perspective.jpg}{\jdc, Walters WP, Kosuri S, Fraser JS}{Blind challenges let us see the path forward for predictive models}{\emph{Preprint}}{preprints.org}{https://www.preprints.org/manuscript/202512.1130}{In this perspective, we discuss how blind community challenges powered by large open data projects are an essential part of the scientific engine powering rapid iterative advances in predictive modeling for drug discovery.}

\newarticle{openadmet-perspective.jpg}{Fraser JS, Edgar S, Handly LN, Kosuri S, \jdc, Murcko M, Walters WP}{OpenADMET: Embracing the Avoid-Ome to Transform Drug Discovery}{\emph{Preprint}}{preprints.org}{https://www.preprints.org/manuscript/202512.1202}{The OpenADMET project aims to tackle the most important problem in drug discovery---addressing the fact that 90\% of discovery compounds fail to meet ADMET objectives---by generating the essential structural and assay data to enable the development of mechanistic predictive ADMET models. This perspective reviews the goals, scope, and approach of this important open science project.}

\newarticle{asap-openadmet-polaris-challenge.pdf}{MacDermott-Opeskin H, Scheen J, Wognum C, Horton JT, West D, Payne AM, Castellanos MA, Colby S, Griffen E, Cousins D, Stacey J, Reid L, Aschenbrenner JC, Fearon D, Balcomb B, Marples P, Tomlinson CWE, Lithgo R, Winokan M, Barr H, Lahav N, Lavi M, Duberstein S, Cohen G, Fate G, Lefker B, Robinson R, Szommer T, Lynch N, Sch\"utzer de Godoy A, Minh DDL, La VNT, Kang L, Huddleston K, Renslow R, Tollefson M, Walters WP, Xu C, Hsu J, St-Laurent J, Etsmoberg H, Zhu L, Quirke A, Haleem MIA, Alibay I, Baid G, Birnbaum B, Bishop KP, Bohorquez H, Bose A, Brown CJ, Burns J, Cai L, Cedeno R, de Cesco S, Chupakhin V, Clark F, Cole DJ, Corbi-Verge C, Danial M, Davi A, Dehaen W, Doering NP, Dougha A, Dr\'eanic MP, Eakin B, Ehrlich A, Elijosius R, F\"ul\"op J, Gitter A, Goossens K, Gu Y, Head-Gordon T, Hoffer L, Hofmans J, Jiang E, Kaminow B, Khosravi S, Khoualdi AF, Lenselink EB, Liu Z, Liu Y, Liu S, Ma Y, Maher P, Mayer I, Mendez-Lucio O, Mey A, Michel J, Montanari F, Niu T, Ogino R, Palaniappan A, Pan X, Patnaik A, Pham L-H, Pinto L, Purnomo J, Rich A, Schaaf L, Schran C, Singh RK, Srilakshmi M, Srivastava SP, Sun K, Sun Z, Talagayev V, Balakrishnan BTS, Titus I, Tkatchenko A, Treyde W, Tricarico G, Tripp A, Vithayapalert N, Wang Y, Wasi AT, Wedig S, Wolber G, Xu B, Zhou W, von Delft F, Kirkegaard K, Sj\"o P, Fraser J, \jdc}{A computational community blind challenge on pan-coronavirus drug discovery data}{\emph{Preprint}}{chemRxiv}{https://doi.org/10.26434/chemrxiv-2025-zd9mr-v6}{This work describes the results of a large-scale community blind challenge to predict target-bound poses, binding affinities, and ADMET properties for compounds from a complete real-world antiviral drug discovery program fielded by the ASAP antiviral drug discovery center prior to data disclosure, thereby providing an accurate assessment of the current performance of predictive models and focusing the community on challenges that remain to improvement of predictive models. There were over 93 submissions for the final leaderboard. Significant post-challenge engagement encouraged rapid sharing of learnings.}

\newarticle{asap-docking-study.pdf}{\underline{Payne AM}, \underline{Kaminow B}, MacDermott-Opeskin H, Pulido I, Scheen J, \underline{Castellanos MA}, Fearon D, \jdc, \underline{Singh S}}{How many crystal structures do you need to trust your docking results?}{\emph{Preprint}}{bioRxiv}{https://doi.org/10.1101/2025.09.19.677428}{Using abundant X-ray structure data from real-world discovery programs from the open science COVID Moonshot and ASAP Antiviral Discovery Consortium efforts, we evaluate optimal strategies for leveraging X-ray data in structure-enabled discovery programs to support lead optimization efforts through computational and machine learning pipelines.}

\newarticle{antiviral-spectrum.pdf}{\underline{Castellanos MA}, \underline{Payne AM}, Scheen J, MacDermott-Opeskin H, Pulido I, Balcomb BH, Griffen EJ, Fearon D, Barr H, Lahav N, Cousins D, Stacey J, Robinson R, Lefker B, \jdc}{A structure-based computational pipeline for broad-spectrum antiviral discovery}{\emph{Preprint}}{bioRxiv}{https://doi.org/10.1101/2025.07.29.667267}{This work presents a structure-based computational pipeline for leveraging co-folding and docking methods to predict antiviral spectrum for small molecule antiviral drug discovery. The accuracy of the approach---and various accuracy-limiting steps---are assessed using data from the ASAP Antiviral Discovery Consortium.}

\newarticle{DNDI-6510.jpg}{Griffen EJ, Fearon D, McGovern BL, Koekemoer L, Balcomb BH, Szommer T, Fate G, Robinson RP, Lefker BA, Duberstein S, Lahav N, The COVID Moonshot Consortium, Braillard S, Vangeel L, Laporte M, Charvillon FB, MacLeod AK, Wells A, Garner P, Knight R, Rees P, Simon A, Jochmans D, Neyts J, Read KD, Barr H, Rombinson M, Lee AL, London N, \jdc, von Delft F, White KM, Perry B, Sj\"{o} P, von Delft A}{Open-science discovery of DNDI-6510, a compound that addresses genotoxic and metabolic liabilities of the COVID Moonshot SARS-CoV-2 Mpro lead inhibitor}{\emph{Preprint}}{bioRxiv}{https://www.biorxiv.org/content/10.1101/2025.06.16.660018v1}{We describe the late-stage lead optimization and early preclinical development of DNDI-6510, a novel orally bioavailable antiviral with nanomolar activity against SARS-CoV-2.}

%%%

\newarticle{fine-tuning-hydration-free-energies.jpg}{\underline{Rufa D}, Fass H, \jdc}{Fine-tuning molecular mechanics force fields to free energies}{\emph{Preprint}}{bioRxiv}{https://doi.org/10.1101/2025.01.06.631610}{We demonstrate how to fine-tune a molecular mechanics foundation model to experimental free energies using a fast one-shot low-rank approximation that does not require additional simulations.}
...
\newarticle{prospective-kinase-mutations.jpg}{Singh S$^\ddag$, Gapsys V, Aldeghi M, Schaller D, Rangwala AM, White JB, Bluck JP, Scheen J, Glass WG, Guo J, Hayat S, de Groot BL, Volkamer A, Christ CD, Seeliger MA, \jdc$^\ddag$}{Prospective evaluation of structure-based simulations reveal their ability to predict the impact of kinase mutations on inhibitor binding}{\emph{Preprint}}{bioRxiv}{https://www.biorxiv.org/content/10.1101/2024.11.15.623861v1.abstract}{We show that alchemical free energy calculations have the potential to prospectively predict the impact of clinical kinase mutations on targeted kinase inhibitor binding.}

\newarticle{espaloma-0.3.pdf}{Takaba K$\ddag$, Friedman AJ, Cavender CE, Behara PK, Pulido I, Henry MM, MacDermott-Opeskin H, Iacovella CR, Nagle AM, Payne AM, Shirts MR, Mobley DL, \jdc$\ddag$, Wang Y$\ddag$}{Machine-learned molecular mechanics force fields from large-scale quantum chemical data}{Chemical Science 15:12861, 2024}{DOI}{https://doi.org/10.1039/D4SC00690A}{We present a new self-consistent MM force field trained on $>$1.1M quantum chemical calculations that uses graph nets to achieve high accuracy and produce accurate protein-ligand binding free energies.}
...
% new
\newarticle{need-for-blind-benchmarks}{Kramer C, \jdc, Damm-Ganamet KL, Gilson MK, G\"{u}nther J, Lessel U, Lewis RA, Mobley D, Nittinger E, Pecina A, Schapira M, Walters WP}{The need for continuing blinded pose- and activity prediction benchmarks}{\emph{Journal of Chemical Information and Modeling} 65:2180, 2025}{DOI}{https://doi.org/10.1021/acs.jcim.4c02296}{In this perspective, we discuss the importance of continuing blinded pose- and activity-prediction benchmarks to drive progress in computational modeling for drug discovery.}

% new
\newarticle{neural-network-potentials-perspective}{Barnett S and \jdc}{Neural network potentials for enabling advanced small-molecule drug discovery and generative design}{\emph{GEN Biotechnology} 3:119, 2024}{DOI}{https://doi.org/10.1089/genbio.2024.0011}{This perspective examines the potential for a new generation of molecular simulation models based on neural network potentials to transform small molecule drug discovery.}

% new
\newarticle{drug-target}{Akinsanya K, AlQuraishi M, Boija A, \jdc, Cichoriska A, LeVine MV, Moult J, Stuart L, Tourassi G, Zou J, Barzilay R, Elemento O}{Redefining druggable targets with artificial intelligence}{\emph{Nature Biotechnology} 43:1416, 2025}{DOI}{https://doi.org/10.1038/s41587-025-02770-1}{We review opportunities for AI to enable advances in developing medicines for previously undruggable targets as the outcome of a Cancer Moonshot initiative workshop hosted at the NIH.}
...
\newarticle{trastuzumab.jpg}{Chen W, Gupta A, Mai N, Nag S, Lau JS, \underline{Singh S}, \jdc, Liu B, de Stanchina E, Pareja F, Hashmi AA, Lieberman M, Modi S, Bromberg J, Razavi P, Drago JZ, Chandarlapaty S}{Trastuzumab Deruxtecan Resistance via Loss of HER2 Expression and Binding}{Cancer Discovery 2026 Online First}{DOI}{https://doi.org/10.1158/2159-8290.cd-25-0647}{We identify ERBB2 mutations at the trastuzumab binding interface that promote trastuzumab deruxtecan (T-DXd) resistance, and demonstrate the mechanism of resistance with alchemical free energy calculations.}


\newarticle{kinodata.jpg}{L\'{o}pez-R\'{i}os de Castro R, Rodr\'{i}guez-Guerra J, Schaller D, Kimber TB, Taylor C, White JB, Backenk\"{o}hler M, Gro{\ss} J, Payne AM, Kaminow B, Pulkido I, Singh S, Kramer PL, P\'{e}rez-Hern\'{a}ndez G, Volkamer A, \jdc}{The journey of data: Lessons learned in modeling kinase affinity, selectivity, and resistance}{\emph{Living Journal of Computational Molecular Science} 6:3875, 2025}{DOI}{https://doi.org/10.33011/livecoms.6.1.3875}{We review lessons learned in the curation of data and construction of likelihood functions for the area of drug discovery best positioned to be transformed by structure-based machine learning approaches---selective kinase inhibitor discovery.}

%%%

\newarticle{kinase-docking}{\underline{Schaller D}, Christ CD, \jdc, Volkamer A}{Benchmarking cross-docking strategies for structure-informed machine learning in kinase drug discovery}{Journal of Chemical Information and Modeling 64:8848, 2024}{DOI}{https://doi.org/10.1021/acs.jcim.4c00905}{We assess strategies for predicting useful docked ligand poses for structure-informed machine learning for kinase inhibitor drug discovery.}

\newarticle{de-fabritiis-nnp-free-energy.jpg}{Zariquiey FS, Galvelis R, Gallicchio E, \jdc, Markland TE, de Fabritiis G}{Enhancing protein–ligand binding affinity predictions using neural network potentials}{Journal of Chemical Information and Modeling 64:1481, 2024}{DOI}{https://doi.org/10.1021/acs.jcim.3c02031}{We show that hybrid neural network / molecular mechanics potentials can significantly improve accuracy over molecular mechanics potentials alone in predicting protein-ligand binding affinities.}
...
\talk{10 Jan 2025}{UC Berkeley}Teaching free energy calculations to learn \\ {\small Berkeley Stat Mech}\vspace{0.5ex}

\talk{06 Dec 2024}{Berlin}Teaching free energy calculations to learn \\ {\small ELLIS ML Workshop}\vspace{0.5ex}

\talk{29 Oct 2024}{Toronto} Blending physics with machine learning to power the future of drug discovery \\ {\small ICBS Toronto}\vspace{0.5ex}

\talk{23 Oct 2024}{ZOOM}NCATS Assay Guidance Manual: Physical Modeling in Drug Discovery\\ {\small NCATS AGM}\vspace{0.5ex}

\talk{22 Oct 2024}{ZOOM} The past, present, and future of free energy calculations in drug discovery \\ {\small BioExcel}\vspace{0.5ex}

\talk{14 Oct 2024}{Washington DC} Opportunities for AI/ML acceleration in drug discovery through large-scale open science initiatives {\small Biden Cancer Moonshot}\vspace{0.5ex}

\talk{1 Oct 2024}{Bologna, Italy} The past, present, and future of biomolecular modeling and simulation in drug discovery \\ {\small NVIDIA MD Workshop}\vspace{0.5ex}

\talk{7 Mar 2024}{Santa Fe} ML/MM REPEX/ATM FEP/MBAR RBFEs and you \\ {\small OpenEye CUP XXIII}\vspace{0.5ex}
...
03/01/2024 -- 02/28/2029\\
{\bf Teaching free energy calculations to learn}\\
\emph{This proposal supports the development and integration of advanced machine learning methods for alchemical free energy calculations}\\
\$306,000 annual direct costs to the Chodera lab\\
...
ARPA-H (PI: James Fraser, UCSF)\\
10/1/2024 -- 9/30/2027\\
{\bf OpenADMET: Structurally enabling the "avoid-ome" to accelerate drug discovery}\\
\emph{The role of the Chodera lab in this project is to lead the computational and data aspects of the project and develop innovative structure-based machine learning methods for ADMET property prediction}\\
\$263,714 annual direct costs to the Chodera lab

\vspace{1.5ex}

Gates Foundation INV-080847 (PI: Kyu Rhee, WCMC)\\
10/1/2024 -- 9/30/2027\\
{\bf OpenAMR: Open AI/ML-assisted bacterial permeability platform}\\
\emph{The role of the Chodera lab in this project is to lead the computational and data aspects of the project and develop innovative structure-based machine learning methods for antimicrobial resistance (AMR) : bacterial permeability and metabolism}\\
\$86,949.52 annual direct costs to the Chodera lab
...
\$12,427 annual direct costs to the Chodera lab\\
...
\emph{The goal of this project is to develop structure-informed machine learning approaches to predicting kinase inhibitor polypharmacology for computer-guided small molecule design.}\\
%1/1/2019 -- 6/30/2022\\
1/1/2019 -- 12/31/2024\\
...
{\bf NIH K99 CA286801 : Quantitatively predicting drug-resistant mutations to improve precision oncology}\\
6/1/2024 -- 5/31/2026\\
\$288,112 total stipend support
...
NIH RM1 BTOD Center (PI: Chodera)\\
12/1/2025 -- 11/30/2030\\
{\bf The Open Molecular Software Foundation (OMSF) BTOD Center}\\
\emph{John Chodera is the PI of this Biomolecular Technology Optimization and Dissemination grant that aims to develop open source molecular mechanics force field parameterization and alchemical free energy calculation tools at the Open Molecular Software Foundation.}\\
\$1M/year total direct costs
...
\begin{itemize}
  ...
  \item Ariana Brenner Clerkin, PhD Rockefeller (12/1/2024--) \\
  Postdoctoral Research Fellow \\
  \emph{Automated curation of protein:ligand binding affinity datasets for force field and free energy methodology assessment and structure-based machine learning}

  \item Devany West, PhD Rockefeller (12/1/2024--) \\
  Postdoctoral Research Fellow \\
  \emph{Ligand- and structure-based machine learning of ADMET properties}

  \item Raquel López-Ríos de Castro, PhD Kings College {\bf (Berlin group)}\\
  \emph{Structure-based machine learning for selective kinase inhibitor therapeutics in cancer}

  \item Guillermo Pérez-Hernández, PhD {\bf (Berlin group)}\\
  \emph{Structure-based machine learning for selective kinase inhibitor therapeutics in cancer}
...
\begin{itemize}
  ...
  % check this
  \item Shuai Yan (7/1/2024--)\\
  Program in Physiology, Biophysics, and Systems Biology (PBSB)\\
  \emph{Neural network potentials for biomolecular and organometallic systems}
...
\begin{itemize}
  \item Mark Polk (8/1/2024--)\\
  \emph{Lab manager and chief robot wrangler; Automated measurements of small molecule binding affinities to model drug targets for improving quantitative predictions for drug discovery}
...
\begin{itemize}
  ...
  \item Dominic Rufa (4/1/2019--1/8/2025)\\
  Tri-Institutional Program in Computational Biology and Medicine (CBM)\\
  %\emph{Machine learning for alchemical free energy calculations}
  Current position: \emph{Scientist}, \href{https://www.sandboxaq.com/}{SandboxAQ}
