...
{\small \it h-index: 38 / i10-index: 54 / citations: 7806 (3 Oct 2018)} \\
...
\quad
\begin{minipage}[t]{3in}
\includegraphics[width=3in,valign=c]{thumbnails/citations-2018-10-03.png}
...
\talk{2 Sep 2018}{Vienna, Austria}Rare events and large-scale conformational changes ?in drug discovery\\ {\small ECAM Workshop: Large scale activated event simulations}\vspace{0.5ex}
