...
{\small \it h-index: 58 / i10-index: 113 / citations: 18653 (21 Mar 2023)} \\
...
\includegraphics[width=2.8in,valign=t]{thumbnails/citations-2023-03-21.pdf}

\vspace{0.05in}
{\small annual citation counts via Google Scholar (21 Mar 2023)}
\end{minipage}
...
\begin{itemize}
  ...
  Tri-Institutional Program in Computational Biology and Medicine (CBM)\\
  \emph{Machine learning for kinase-directed drug discovery}  
