...
\newcommand{\newarticleold}[5]{
\noindent\marginpar{
  \parbox[c][1.0in][c]{0.50in}{{\includegraphics[width=0.9in]{thumbnails/{#1}}}}
}{ {#2} $\cdot$ \href{#4}{#3} \\ {\footnotesize\emph {#5} } }\\
\vspace{0.4in}
}
%
\newcommand{\newarticle}[5]{
...
%\sectionfont{\rmfamily\mdseries\large\underline} 
%\subsectionfont{\rmfamily\mdseries\scshape\normalsize} 
%\subsubsectionfont{\rmfamily\bfseries\upshape\normalsize} 
...
\begin{document}
\reversemarginpar
%\textrm{\LARGE John D. Chodera}\\[1cm]
{\fontseries{eb}\selectfont \LARGE John D. Chodera}\\[1cm]
%{\bf email} \href{mailto:jchodera@stanford.edu}{\nolinkurl{jchodera@stanford.edu}}\\
%{\bf url} \href{http://www.dillgroup.ucsf.edu/~jchodera}{\nolinkurl{http://www.dillgroup.ucsf.edu/~jchodera}}\\[0.05in]
%{\bf tel} 415.867.7384\\
%{\bf fax} 415.502.4222 \\[0.05in]
%{\bf snail mail} \\
%Pande group\\
%Clark Center, MC 5447\\
%Stanford University\\
%Stanford, CA 94305-5447\\[0.05in]

\begin{minipage}[t]{1.2in}
\includegraphics[width=1.2in,valign=c]{images/john_chodera_lg.pdf}
\end{minipage}
\quad
...
\noindent\years{2008--2012}{\bf Distinguished Postdoctoral Fellow, California Institute for Quantitative Biosciences (QB3),\\
...
%\noindent {\bf Alchemical free energy calculations of ligand binding}\\ {\small \emph{(with Vijay Pande, Stanford; David Mobley, U. of New Orleans; Michael Shirts, U. of Virginia)}}\\
%\noindent {\bf Master equation models of biomolecular dynamics from atomistic simulation}\\ {\small \emph{(with Nina Hinrichs, University of Chicago; Bill Swope, IBM Almaden; Frank No\'{e}, FU Berlin)}}\\
%\noindent {\bf Comprehensive comparison of the folding of trpzip2}\\ {\small \emph{(with Bill Swope, IBM Almaden; Martin Gruebele, UIUC; Andrei Tokmakoff, MIT)}}\\
%%\noindent {\bf Efficient estimators and optimal intermediates for free energy calculations}\\ {\small \emph{(with Michael Shirts, Columbia)}}\\
%\noindent {\bf Analysis of equilibrium and nonequilibrium single-molecule experiments}\\ {\small \emph{(with Susan Marqusee, UCB; David Minh, NIH; Michael T. Woodside, U. Alberta; Nina Hinrichs and Norbert Scherer, U. Chicago)}}\\
%%\noindent {\bf Calculation of multidimensional infrared spectra}\\ {\small \emph{(with Thomas la Cour Jansen, Groningen; Andrei Tokmakoff, MIT)}}\\
%\noindent {\bf Bayesian analysis of isothermal titration calorimetry data} \\ {\small \emph{(with Kim Branson, Stanford University)}}\\
%\noindent {\bf Testing a polarizable forcefield by free energy calculations} \\ {\small \emph{(with Jay Ponder, Washington University St.~Louis and Pengyu Ren, UT Austin)}}
%%%\noindent {\bf Extraction of conformational ensembles from NMR data}\\ {\small \emph{(with Michael F. Kim, UCSF and Gerhard Stock, University of Frankfurt)}}\\

\section*{Publications}

Google Scholar statistics: \href{http://goo.gl/qO0JW}{http://goo.gl/qO0JW}\\

{\small \it h-index: 22 / i10-index: 31 / first author: 10 / corresponding author: 7 / published or in press: 42}
...
\newarticle{identifying-ligand-binding-sites.pdf}{Wang K, {\bf Chodera JD}, Yang Y, and Shirts MR. Identifying ligand binding sites and poses using GPU-accelerated Hamiltonian replica exchange molecular dynamics. {\it J.~Comput.~Aid.~Mol.~Des.}, in press}{DOI}{http://dx.doi.org/10.1007/s10822-013-9689-8}{We show how bound ligand poses can be identified even when the location of the binding sites are unknown using the machinery of alchemical modern free energy calculations on graphics processors.}

%\article{DOI}{http://dx.doi.org/10.1007/s10822-013-9689-8}Wang K, {\bf Chodera JD}, Yang Y, and Shirts MR. Identifying ligand binding sites and poses using GPU-accelerated Hamiltonian replica exchange molecular dynamics. {\it J.~Comput.~Aid.~Mol.~Des.}, in press.\\
%\desc{identifying-ligand-binding-sites.pdf}{We show how bound ligand poses can be identified even when the location of the binding sites are unknown using the machinery of alchemical modern free energy calculations on graphics processors.}
...
%\article{DOI}{http://dx.doi.org/10.1146/annurev-biophys-083012-130318}{\bf Chodera JD}$^\dag$ and Mobley DL. Entropy-enthalpy compensation: Role and ramifications for rational ligand design. {\it Annu.~Rev.~Biophys.}, 42:121, 2013.\\
%\desc{entropy-enthalpy-compensation.pdf}{Entropy-enthalpy compensation is likely a universal phenomena, but not as severe as widely thought, and likely not of enormous concern for drug discovery and ligand design.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.sbi.2011.01.011}{\bf Chodera JD}, Mobley DL, Shirts MR, Dixon RW, Branson KM, and Pande VS. Free energy methods in drug discovery and design: Progress and challenges. {\it Curr.~Opin.~Struct.~Biol.}, 21:150--160, 2011.\\
%\desc{alchemical-methods.pdf}{A review of the opportunities and challenges for alchemical free energy calculations in drug discovery and design.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.2978177}Shirts MR, {\bf Chodera JD}. Statistically optimal analysis of samples from multiple equilibrium states. {\it J.~Chem.~Phys.} 129:124105, 2008.\\
%\desc{mbar-equation.pdf}{We present a highly general, statistically optimal approach for producing estimates of free energies and equilibrium expectations from multiple simulations that provably extracts all useful information from the data.}
...
%\article{DOI}{http://dx.doi.org/10.1021/jm070549+}Nicholls A*, Mobley DL*, Guthrie JP, {\bf Chodera JD}, and Pande VS. Predicting small-molecule solvation free energies: A blind challenge test for computational chemistry. {\it J.~Med.~Chem.} 51:769--779, 2008.\\
%\desc{small-molecule-solvation.pdf}{A blind evaluation of the accuracy of alchemical free energy methods for computing gas-to-water transfer free energies (solvation free energies) of small molecules demonstrates that modern forcefields are likely sufficiently accurate to be useful in drug design.}
...
%\article{DOI}{http://dx.doi.org/10.1021/jp0764384}Mobley DL, Dill KA, and {\bf Chodera JD}. Treating entropy and conformational changes in implicit solvent simulations of small molecules {\it J.~Phys.~Chem.~B} 112(3):938--946, 2008.\\
%\desc{entropy-solvation.pdf}{An quantitative examination of how much conformational entropy contributes to hydration free energies of small molecules, with implications for ligand binding.}

%\vspace{0.5in}

\newarticle{long-range-dispersion-correction.pdf}{Shirts MR*, Mobley DL*, {\bf Chodera JD}, Bayly CI, Cooper MD, and Pande VS. Accurate and efficient corrections for missing dispersion interactions in molecular simulations.  {\it J.~Phys.~Chem.~B} 111(45):13052--13063, 2007}{DOI}{http://dx.doi.org/10.1021/jp0735987}{We identify a major source of systematic error in absolute alchemical free energy calculations of ligand binding and show how a simple procedure can inexpensively and accurately eliminate it.}

%\article{DOI}{http://dx.doi.org/10.1021/jp0735987}Shirts MR*, Mobley DL*, {\bf Chodera JD}, Bayly CI, Cooper MD, and Pande VS. Accurate and efficient corrections for missing dispersion interactions in molecular simulations.  {\it J.~Phys.~Chem.~B} 111(45):13052--13063, 2007.\\
%\desc{long-range-dispersion-correction.pdf}{We identify a major source of systematic error in absolute alchemical free energy calculations of ligand binding and show how a simple procedure can inexpensively and accurately eliminate it.}

%\vspace{0.5in}

\newarticle{charge-models.pdf}{Mobley DL, Dumont E, {\bf Chodera JD}, and Dill KA. Comparison of charge models for fixed-charge force fields: Small-molecule hydration free energies in explicit solvent.  \emph{J.~Phys.~Chem.~B} 111:2242--2254, 2007}{DOI}{http://dx.doi.org/10.1021/jp0667442}{We compare a number of popular methods for deriving charge models for small molecules, deriving lessons about best practices for accurate simulations.}

%\article{DOI}{http://dx.doi.org/10.1021/jp0667442}Mobley DL, Dumont E, {\bf Chodera JD}, and Dill KA. Comparison of charge models for fixed-charge force fields: Small-molecule hydration free energies in explicit solvent.  \emph{J.~Phys.~Chem.~B} 111:2242--2254, 2007.\\
%\desc{charge-models.pdf}{We compare a number of popular methods for deriving charge models for small molecules, deriving lessons about best practices for accurate simulations.}
...
%\article{DOI}{http://dx.doi.org/10.1016/S1574-1400(07)03004-6}Shirts MR, Mobley DL, {\bf Chodera JD}. Alchemical free energy calculations: Ready for prime time? {\it Ann.~Rep.~Comput.~Chem.} 3:41--59, 2007.\\
%\desc{binding-free-energy.pdf}{A review on alchemical free energy methods and whether they are ready for practical use in drug discovery and ligand design.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.jmb.2007.06.002}Mobley DL, Graves AP, {\bf Chodera JD}, McReynolds AC, Shoichet BK, and Dill KA. Predicting absolute ligand binding free energies to a simple model site. {\it J.~Mol.~Biol.} 371(4):1118--1134, 2007.\\
%\desc{t4-lysozyme-l99a}{We show how alchemical free energy calculations are capable of accurate blind prediction of small-molecule binding affinities to a simple model protein binding site.}
...
%\article{DOI}{http://dx.doi.org/10.1021/ct700032n}Mobley DL, {\bf Chodera JD}, and Dill KA. Confine-and-release method: Obtaining correct binding free energies in the presence of protein conformational change. {\it J.~Chem.~Theor.~Comput.} 3(4):1231--1235, 2007.\\
%\desc{t4-lysozyme-val111.pdf}{We present a general scheme for obtaining correct ligand binding affinities when protein conformational change is implicated in ligand binding.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.2221683}Mobley DL, {\bf Chodera JD}, and Dill KA. On the use of orientational restraints and symmetry corrections in alchemical free energy calculations. {\it J.~Chem.~Phys.} 125:084902, 2006. \\ %\\ \emph{Selected for the Virtual Journal of Biological Physics Research 12(5), 2006.} 
%\desc{orientational-restraints.pdf}{We illustrate how orientational restraints can be used to greatly reduce the computational effort in alchemical calculations of ligand binding free energies, and clarify how symmetry corrections are necessary when molecules contain symmetric or pseudosymmetric substituents.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.ab.2011.03.024}Tellinghuisen JT and {\bf Chodera JD}. Systematic errors in isothermal titration calorimetry: Concentrations and baselines. {\it Anal.~Biochem.}, 414:297--299, 2011.\\
%\desc{itc-enthalpogram.pdf}{A word of caution about large errors in isothermal titration calorimetry measurements arising from ligand concentration errors.}
...
\newarticle{iamoeba-water}{Wang L-P, Head-Gordon TL, Ponder JW, Ren P, {\bf Chodera JD}, Eastman PK, Martines TJ, and Pande VS. Systematic improvement of a classical molecular model of water. {\it J.~Phys.~Chem.~B}, 117:9956--9972, 2013}{DOI}{http://dx.doi.org/10.1021/jp403802c}{A new inexpensive polarizable model of liquid water for next-generation forcefields is derived using an automated parameterization engine.}

%\article{DOI}{http://dx.doi.org/10.1021/jp403802c}Wang L-P, Head-Gordon TL, Ponder JW, Ren P, {\bf Chodera JD}, Eastman PK, Martines TJ, and Pande VS. Systematic improvement of a classical molecular model of water. {\it J.~Phys.~Chem.~B}, in press.\\
%\desc{iamoeba-water}{A new inexpensive polarizable model of liquid water for next-generation forcefields is derived using an automated parameterization engine.}
...
%\article{DOI}{http://dx.doi.org/10.1103/PhysRevX.3.011007}Sivak DA, {\bf Chodera JD}, and Crooks GE. Using nonequilibrium fluctuation theorems to understand and correct errors in equilibrium and nonequilibrium discrete Langevin dynamics simulations. {\it Phys.~Rev.~X.}, 3:011007, 2013.\\
%\desc{nonequilibrium-fluctuation-theorems}{The finite-timestep errors in molecular dynamics simulations can be interpreted as a form of nonequilibrium work.  We show how this leads to straightforward schemes for correcting for these errors or assessing their impact.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3660669}{\bf Chodera JD} and Shirts MR. Replica exchange and expanded ensemble simulations as Gibbs sampling: Simple improvements for enhanced mixing. \emph{J.~Chem.~Phys.}, 135:194110, 2011.\\
%\desc{gibbs-sampling.pdf}{We show how a simple change to the way exchanges are handled in the popular replica-exchange simulation methodology can enormously increase efficiency at no increase in computational cost.}
...
%\article{DOI}{http://dx.doi.org/10.1073/pnas.1106094108}Nilmeier JP, Crooks GE, Minh DDL, and {\bf Chodera JD}$^\dag$. Nonequilibrium candidate Monte Carlo is an efficient tool for equilibrium simulation. {\it Proc.~Natl.~Acad.~Sci.~USA.}, 108:E1009, 2011.\\
%\desc{ncmc.pdf}{We present a significant generalization of Monte Carlo methods that provide an enormously useful tool for enhancing the efficiency of molecular simulations and enabling molecular design.}

%\vspace{0.5in}

\newarticle{current-status-amoeba.pdf}{Ponder JW, Wu C, Ren P, Pande VS, {\bf Chodera JD}, Mobley JD, Schnieders MJ, Haque I, Lambrecht DS, DiStasio RA Jr., Head-Gordon M,  Clark GNI, Johnson ME, and Head-Gordon T. Current status of the AMOEBA polarizable force field. {\it J.~Phys.~Chem.~B} 114:2549, 2010}{DOI}{http://dx.doi.org/10.1021/jp910674d}{A report on the status of the AMOEBA polarizable force field and its ability to reproduce a diverse set of physical chemical phenomenon to high accuracy.}

%\article{DOI}{http://dx.doi.org/10.1021/jp910674d}Ponder JW, Wu C, Ren P, Pande VS, {\bf Chodera JD}, Mobley JD, Schnieders MJ, Haque I, Lambrecht DS, DiStasio RA Jr., Head-Gordon M,  Clark GNI, Johnson ME, and Head-Gordon T. Current status of the AMOEBA polarizable force field. {\it J.~Phys.~Chem.~B} 114:2549, 2010.\\
%\desc{current-status-amoeba.pdf}{A report on the status of the AMOEBA polarizable force field and its ability to reproduce a diverse set of physical chemical phenomenon to high accuracy.}
...
%\article{DOI}{http://dx.doi.org/10.1021/ct0502864}{\bf Chodera JD}, W. C. Swope, J. W. Pitera, C. Seok, and K. A. Dill. Use of the weighted histogram analysis method for the analysis of simulated and parallel tempering simulations. \emph{J.~Chem.~Theor.~Comput.} 3(1):26--41, 2007.\\
%\desc{alanine-dipeptide-2dpmf.pdf}{The weighted histogram analysis method (WHAM), a mainstay of molecular dynamics simulation analysis, is thoroughly explained and modernized for the analysis of simulated and parallel tempering simulation data.}
...
%\article{DOI}{http://dx.doi.org/10.1002/jcc.10124}Seok C, Rosen JB, {\bf Chodera JD}, Dill KA. MOPED: Method for optimizing physical energy parameters using decoys. {\it J.~Comput.~Chem.} 24(1):89--97, 2003.\\
%\desc{moped.pdf}{We propose a novel way to optimize parameters for a physical energy function for protein folding studies by making use of `decoy' structures.}
...
\newarticle{spectral-rate-theory.pdf}{Prinz J-H, {\bf Chodera JD}, and No\'{e} F. Spectral rate theory for two-state kinetics. {\it Phys.~Rev.~X.}, in press}{ar$\chi$iv}{http://arxiv.org/abs/1207.0225}{We present a new mathematical framework for unifying various two-state rate theories presented in the physical chemistry literature over many decades, and provide a quantitative way to measure reaction coordinate quality.}

%\article{ar$\chi$iv}{http://arxiv.org/abs/1207.0225}Prinz J-H, {\bf Chodera JD}, and No\'{e} F. Spectral rate theory for two-state kinetics. {\it Phys.~Rev.~X.}, in press.\\
%\desc{spectral-rate-theory.pdf}{We present a new mathematical framework for unifying various two-state rate theories presented in the physical chemistry literature over many decades, and provide a quantitative way to measure reaction coordinate quality.}
...
%\article{DOI}{http://dx.doi.org/10.1021/ct300857j}Eastman P, Friedrichs MS, {\bf Chodera JD}, Radmer RJ, Bruns CM, Ku JP, Beauchamp KA, Lane TJ, Wang L, Shukla D, Tye T, Houston M, Stich T, Klein C, Shirts MR, and Pande VS. OpenMM 4: A reusable, extensible, hardware independent library for high performance molecular simulation. {\it J.~Chem.~Theor.~Comput.}, 9:461, 2012.\\
%\desc{openmm-logo.pdf}{We describe the latest version of an open-source, GPU-accelerated library and toolkit for molecular simulation.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.bpj.2012.06.051}Elms PJ, {\bf Chodera JD}, Bustamante CJ, Marqusee S. The limitations of constant-force-feedback experiments. {\it Biophys.~J.}, 103:1490, 2012.\\
%\desc{constant-force-feedback.pdf}{Popular constant-force-feedback single-molecule experiments can cause severe artifacts in single-molecule force spectroscopy data.  We demonstrate a simple alternative that eliminates these artifacts.}
...
%\article{DOI}{http://dx.doi.org/10.1073/pnas.1115519109}Elms PJ, {\bf Chodera JD}, Bustamante C, Marqusee S. The molten globule state is unusually deformable under mechanical force. {\it Proc.~Natl.~Acad.~Sci.~USA.}, 109:3796, 2012.\\
%\desc{molten-globule-state.pdf}{We measure the physical properties of the molten globule state of apo-myoglobin, and show that it is unusually deformable compared to typical protein native states.}
...
%\article{DOI}{http://dx.doi.org/10.1126/science.1209740}Kaiser CM, Goldman DH, {\bf Chodera JD}, Tinoco I, Jr., and Bustamante C. The ribosome modulates nascent protein folding. {\it Science}, 334:1723, 2011.\\
%\desc{ribosome-modulates.pdf}{Using single-molecule force spectroscopy, we show how the ribosome itself modulates the folding dynamics of nascent protein chains emerging from the exit tunnel.}
...
%\article{DOI}{http://dx.doi.org/10.1103/PhysRevLett.107.098102}{\bf Chodera JD} and Pande VS. Splitting probabilities as a test of reaction coordinate choice in single-molecule experiments. {\it Phys.~Rev.~Lett.}, 107:098102, 2011.\\
%\desc{splitting-probabilities.pdf}{We demonstrate a simple test for identifying poor reaction coordinates in single-molecule experiments.}
...
%\article{DOI}{http://dx.doi.org/10.1021/ct300112v}Pitera JW and {\bf Chodera JD}. On the use of experimental observations to bias simulated ensembles. {\it J.~Chem.~Theor.~Comput.}, 8:3445, 2012.\\
%\desc{experimental-observables.pdf}{We show how the concept of maximum entropy can be used to recover unbiased conformational distributions from experimental data, and how this concept relates to the popular `ensemble refinement' schemes for NMR data analysis.}
...
%\article{DOI}{http://dx.doi.org/10.1073/pnas.1109571108}{\bf Chodera JD}$^\dag$ and Pande VS. The Social Network (of protein conformations). \emph{Proc.~Natl.~Acad. Sci.~USA} 108:12969, 2011.\\
%\desc{social-network.pdf}{Commentary: A new methodology for mapping protein conformational spaces is reminiscent of how we use two-dimensional maps to navigate a three-dimensional world.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3516517}Minh DDL, {\bf Chodera JD}$^\dag$. Estimating equilibrium ensemble averages using multiple time slices from driven nonequilibrium processes: Theory and application to free energies, moments, and thermodynamic length in single-molecule pulling experiments. {\it J.~Chem.~Phys.} 134:024111, 2011.\\
%\desc{multiple-time-slices.pdf}{We derive a new estimator for estimating equilibrium expectations from nonequilibrium experiments, and show how it can be used to estimate a variety of useful quantities in simulated single-molecule force spectroscopy experiments.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3242285}Minh DDL, {\bf Chodera JD}$^\dag$. Optimal estimators and asymptotic variances for nonequilibrium path-ensemble averages. {\it J.~Chem.~Phys.} 131:134110, 2009. \\ %\\ \emph{Selected for the Virtual Journal of Biological Physics Research 21(2), 2011.}
%\desc{optimal-estimates-nonequilibrium.pdf}{We derive an optimal estimator and corresponding statistical uncertainties for inferring expectations of bidirectional nonequilibrium processes.  These estimators have widespread applicability in single-molecule biophysical force-spectroscopy experiments and nonequilibrium molecular simulations.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3592153}Prinz J-H, {\bf Chodera JD}, Pande VS, Smith JC, and No\'{e} F. Optimal use of data in parallel tempering simulations for the construction of discrete-state Markov models of biomolecular dynamics. \emph{J.~Chem.~Phys.} 134:244108, 2011. \\
%\desc{parallel-tempering.pdf}{We demonstrate how multitemperature data from parallel tempering simulations can be used to construct fully temperature-dependent models of the dynamics of biomolecular systems.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3592152}{\bf Chodera JD}$^\dag$, Swope WC, No\'{e} F, Prinz J-H, Shirts MR, and Pande VS. Dynamical reweighting: Improved estimates for dynamical properties from simulations at multiple temperatures. \emph{J. Chem. Phys.} 134:244107, 2011.\\
%\desc{dynamical-reweighting.pdf}{We describe how reweighing techniques can provide optimal estimates of temperature-dependent dynamical properties from simulations conducted at multiple temperatures.}

%\vspace{0.5in}

\newarticle{markov-model-generation-2.pdf}{Prinz JH, Wu H, Sarich M, Keller B, Fischbach M, Held M, {\bf Chodera JD}, Sch\"{u}tte, and No\'{e} F. Markov models of molecular kinetics: Generation and validation. \emph{J.~Chem.~Phys.} 134:174105, 2011}{DOI}{http://dx.doi.org/10.1063/1.3565032}{A review of current best practices for the generation and validation of Markov state models for describing the stochastic dynamics of biomolecular systems.}

%\article{DOI}{http://dx.doi.org/10.1063/1.3565032}Prinz JH, Wu H, Sarich M, Keller B, Fischbach M, Held M, {\bf Chodera JD}, Sch\"{u}tte, and No\'{e} F. Markov models of molecular kinetics: Generation and validation. \emph{J.~Chem.~Phys.} 134:174105, 2011.\\
%\desc{markov-model-generation-2.pdf}{A review of current best practices for the generation and validation of Markov state models for describing the stochastic dynamics of biomolecular systems.}
...
%\article{DOI}{http://dx.doi.org/10.1073/pnas.1004646108}No\'{e} F, Doose S, Daidone I, L\"{o}llmann M, Sauer M, {\bf Chodera JD}, and Smith JC. Dynamical fingerprints: A theoretical framework for understanding biomolecular processes by combination of simulation and kinetic experiments. \emph{Proc.~Natl.~Acad.~Sci.~USA}, 108:4822, 2011.\\
%\desc{dynamical-fingerprints.pdf}{We present a new framework for comparing essential features of the dynamics between experiment and simulation to identify the kinetics processes contributing to individual relaxation timescales in perturbation-response or correlation spectroscopy experiments.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3463406}{\bf Chodera JD} and No\'e F. Probability distributions of molecular observables computed from Markov models.~II.~Uncertainties in observables and their time-evolution. \emph{J. Chem. Phys.} 133:105102, 2010. \\ %\\ \emph{Selected for September 15, 2010 issue of Virtual Journal of Biological Physics Research.}
%\desc{observable-uncertainty.pdf}{A simple Bayesian approach for the modeling of statistical uncertainties in kinetic and equilibrium quantities computed from Markov state models of biomolecular dynamics.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.bpj.2010.03.056}Adelman JL, {\bf Chodera JD}, Kuo IW, Miller TF, and Barsky D. The mechanical properties of PCNA: Implications for the loading and function of a DNA sliding clamp. {\it Biophys. J.} 98:3062, 2010.  {\it Featured on issue cover.}\\
%\desc{pcna-cover.pdf}{Molecular simulations of the PCNA clamp responsible for DNA polymerase processivity show a surprisingly small energetic penalty for the deformation required for clamp loading.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.3192309}Bacallado S, {\bf Chodera JD}, and Pande VS. Bayesian comparison of Markov models of molecular dynamics with detailed balance constraint. \emph{J.~Chem.~Phys.} 131:045106, 2009.\\
%\desc{bayesian-comparison-markov-models.pdf}{A Bayesian scheme for comparing state space decompositions for Markov state models of biomolecular dynamics that incorporates the fact that physical systems must obey detailed balance.  This paper utilizes results from Markov chain theory on edge-reinforced random walks.}
...
%\article{DOI}{http://dx.doi.org/10.1063/1.2714538}{\bf Chodera JD}*, Singhal N*, Swope WC, Pitera JW, Pande VS, and Dill KA. Automatic discovery of metastable states for the construction of Markov models of macromolecular conformational dynamics. {\it J.~Chem.~Phys.} 126:155101, 2007.\\ %\\ \emph{Selected for May 1, 2007 issue of Virtual Journal of Biological Physics Research.}
%\desc{automatic-state-decomposition-trpzip2.pdf}{Proposing one of the first automated algorithms for discovering kinetically metastable states of biomolecules from molecular simulations, this paper shows how many biomolecules can possess numerous distinct long-lived conformational states even though the the equilibrium populations of these states may too small for standard structural biology techniques to detect.}
...
%\article{DOI}{http://dx.doi.org/10.1073/pnas.0703700104}Ozkan SB, Wu GA, {\bf Chodera JD}, and Dill KA. Protein Folding by Zipping and Assembly. \emph{Proc.~Natl.~Acad.~Sci.~USA} 104(29):11987--11992, 2007.\\
%\desc{zipping-assembly.pdf}{A review of the utility of the proposed zipping and assembly mechanism for the concomitant formation of secondary and tertiary structure in protein folding for predicting folding pathways and native structures.}
...
%\article{DOI}{http://dx.doi.org/10.1016/j.sbi.2007.06.001}Dill KA, Ozkan SB, Weikl TR, {\bf Chodera JD}, and Voelz VA. The protein folding problem: When will it be solved? \emph{Curr.~Opin.~Struct.~Biol.} 17(3):342--346, 2007.\\
%\desc{folding-funnel.pdf}{A review of the current state of the protein folding problem.}
...
%\article{DOI}{http://dx.doi.org/10.1137/06065146X}{\bf Chodera JD}$^\dag$, Swope WC, Pitera JW, and Dill KA. Long-time protein folding dynamics from short-time molecular dynamics simulations. {\it Multiscale~Model.~Simul.} 5(4):1214--1226, 2006.\\
%\desc{alanine-dipeptide.pdf}{We show how the long-time dynamics of biomolecular systems can be recapitulated from statistics collected from short molecular simulations sampling transitions between kinetically metastable states.}
...
%\article{DOI}{http://dx.doi.org/10.1021/ja011096f}Lee TS$^*$, Chong LT$^*$, {\bf Chodera JD}, and Kollman PA. An alternative explanation for the catalytic proficiency of orotidine 5'-phosphate decarboxylase. {\it J.~Am.~Chem.~Soc.} 123(51):12837-12848, 2001.\\
%\desc{odcase.pdf}{A combined QM and MD analysis of potential plausible mechanisms to explain the enormous catalytic acceleration of one of the most proficient enzymes known.}
...
\newarticle{timestep-rescaling.pdf}{Sivak DA, {\bf Chodera JD}, and Crooks GE. Time step rescaling recovers continuous-time dynamical properties for discrete-time Langevin integration of nonequilibrium systems. {\it Submitted}}{ar$\chi$iv}{http://arxiv.org/abs/1301.3800}{We derive a simple, easy-to-implement Langevin integrator that has universally useful properties in molecular simulations.}

%\article{ar$\chi$iv}{http://arxiv.org/abs/1301.3800}Sivak DA, {\bf Chodera JD}, and Crooks GE. Time step rescaling recovers continuous-time dynamical properties for discrete-time Langevin integration of nonequilibrium systems. {\it In revision.}\\
%\desc{timestep-rescaling.pdf}{We derive a simple, easy-to-implement Langevin integrator that has universally useful properties in molecular simulations.}

%\vspace{0.5in}

%\article{}{}Tellinghuisen JT, Boyce SE, and {\bf Chodera JD}. The role of blanks in isothermal titration calorimetry. {\it In revision at Anal.~Biochem.}\\
%\desc{}{}

\newarticle{bhmm.pdf}{{\bf Chodera JD}$^\dag$, Elms PJ, No\'{e} F, Keller B, Kaiser CM, Ewall-Wice A, Marqusee S, Bustamante C, and Hinrichs NS. Bayesian hidden Markov model analysis of single-molecule biophysical experiments. {\it In revision at Biophys.~J.}}{ar$\chi$iv}{http://arxiv.org/find/all/1/all:+chodera/0/1/0/all/0/1}{We present a Bayesian hidden Markov model analysis scheme that allows biomolecular conformational dynamics to be inferred from single-molecule trajectories.}

%\article{ar$\chi$iv}{http://arxiv.org/find/all/1/all:+chodera/0/1/0/all/0/1}{\bf Chodera JD}$^\dag$, Elms PJ, No\'{e} F, Keller B, Kaiser CM, Ewall-Wice A, Marqusee S, Bustamante C, and Hinrichs NS. Bayesian hidden Markov model analysis of single-molecule biophysical experiments. {\it In revision at Biophys.~J.}\\
%\desc{bhmm.pdf}{We present a Bayesian hidden Markov model analysis scheme that allows biomolecular conformational dynamics to be inferred from single-molecule trajectories.}

%\vspace{0.5in}

\newarticle{robust-rate-estimates.pdf}{{\bf Chodera JD}, Elms PJ, Swope WC, Prinz J-H, Marqusee S, Bustamante C, No\'{e} F, and Pande VS. A robust approach to estimating rates from time-correlation functions. \emph{Submitted}}{ar$\chi$iv}{http://arxiv.org/abs/1108.2304}{We present a simple, robust approach to estimating two-state rate constants from experimental or simulation data.}

%\article{ar$\chi$iv}{http://arxiv.org/abs/1108.2304}{\bf Chodera JD}, Elms PJ, Swope WC, Prinz J-H, Marqusee S, Bustamante C, No\'{e} F, and Pande VS. A robust approach to estimating rates from time-correlation functions. \emph{Submitted.}
%\desc{robust-rate-estimates.pdf}{We present a simple, robust approach to estimating two-state rate constants from experimental or simulation data.}
...
%\section*{Peer reviewer for journals}
%
%Bioinformatics
%
%Biopolymers
...
\begin{center}
{\footnotesize Latest version available online at \href{http://www.choderalab.org}{http://choderalab.org} --- this version current as of \today.
}
\end{center}
