...
{\small \it h-index: 39 / i10-index: 54 / citations: 8074 (29 Nov 2018)} \\
...
\quad
\begin{minipage}[t]{3in}
\includegraphics[width=3in,valign=c]{thumbnails/citations-2018-11-29.png}

\vspace{0.05in}
{\small annual citation counts (Google Scholar) -- 29 Nov 2018}
\end{minipage}
...
\newarticle{smarty}{Zanette C, Bannan CC, Bayly CI, Fass J, Gilson MK, Shirts MR, \jdc, Mobley DL}{Toward learned chemical perception of force field typing rules}{\emph{Journal of Chemical Theory and Computation}, in press}{chemRxiv}{https://chemrxiv.org/articles/Toward_Learned_Chemical_Perception_of_Force_Field_Typing_Rules/6230627}{We show how machine learning can learn typing rules for molecular mechanics force fields within a Bayesian statistical framework.}
