...
%new
\newarticle{de-fabritiis-nnp-free-energy.jpg}{Zariquiey FS, Galvelis R, Gallicchio E, \jdc, Markland TE, de Fabritiis G}{Enhancing protein–ligand binding affinity predictions using neural network potentials}{}{DOI}{https://doi.org/10.1021/acs.jcim.3c02031}{We show that hybrid neural network / molecular mechanics potentials can significantly improve accuracy over molecular mechanics potentials alone in predicting protein-ligand binding affinities.}
